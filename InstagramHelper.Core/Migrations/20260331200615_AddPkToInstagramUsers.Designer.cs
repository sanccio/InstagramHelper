...
namespace Core.Migrations
{
    ...
    [Migration("20260331200615_AddPkToInstagramUsers")]
    partial class AddPkToInstagramUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstagramHelper.Core.Models.InstaUser", b =>
                {
            ...
            modelBuilder.Entity("InstagramHelper.Core.Models.Story", b =>
                {
            ...
            modelBuilder.Entity("InstagramHelper.Core.Models.Subscription", b =>
                {
            ...
            modelBuilder.Entity("InstagramHelper.Core.Models.TelegramUser", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("InstagramHelper.Core.Models.Story", b =>
                {
                    b.HasOne("InstagramHelper.Core.Models.InstaUser", "InstaUser")
                        .WithMany("Stories")
            ...
            modelBuilder.Entity("InstagramHelper.Core.Models.Subscription", b =>
                {
                    ...
                    b.HasOne("InstagramHelper.Core.Models.TelegramUser", "TelegramUser")
